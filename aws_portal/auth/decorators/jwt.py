"""
JWT authentication decorators for aws_portal.

This module is deprecated. It provides backward compatibility for the JWT authentication
decorators that were previously in aws_portal.utils.auth.
"""
