...
import pandas as pd
from aws_portal.models import JoinAccountStudy, Study, Account
...
@researcher_db_auth_required("View", "Ditti App Dashboard")
def get_audio_taps(email=None):  # TODO write unit test
    # add expressions to the query to return all taps for multiple studies
    def f(left, right):
        q = "user_permission_idBEGINS\"%s\"" % right
        return left + ("OR" if left else "") + q
...
@researcher_db_auth_required("View", "Ditti App Dashboard")
def get_users(email=None):  # TODO: create unit test
    """
...
@researcher_db_auth_required("View", "Ditti App Dashboard")
@researcher_db_auth_required("View", "Audio Files")
def get_audio_files(email=None):
    """
...
@researcher_db_auth_required("View", "Ditti App Dashboard")
@researcher_db_auth_required("Create", "Audio File")
def audio_file_create(email=None):
    """
...
@researcher_db_auth_required("View", "Ditti App Dashboard")
@researcher_db_auth_required("Delete", "Audio File")
def audio_file_delete(email=None):
    """
...
@researcher_db_auth_required("View", "Ditti App Dashboard")
@researcher_db_auth_required("Create", "Audio File")
def audio_file_generate_presigned_urls(email=None):
    """
