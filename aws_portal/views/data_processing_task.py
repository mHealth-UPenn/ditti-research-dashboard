...
@researcher_db_auth_required("View", "Data Retrieval Task")
def get_data_processing_tasks(task_id: int | None, email=None):
    """
...
@researcher_db_auth_required("Invoke", "Data Retrieval Task")
def invoke_data_processing_task(email=None):
    """
