...
class TestParticipantAuthDecorator:
    ...
    def test_successful_auth(self, MockController, test_app):
        ...
        with test_app.test_request_context("/test-func", headers={"Authorization": "Bearer valid-token"}):
    ...
    def test_auth_failure(self, MockController, test_app):
        ...
        with test_app.test_request_context("/test-func", headers={"Authorization": "Bearer invalid-token"}):
            with test_app.app_context():
                response = test_func()
