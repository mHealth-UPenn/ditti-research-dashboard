...
from tests.tests_install.tests_aws_providers.mock_aws_account_provider import aws_account_provider, mock_aws_region, mock_aws_access_key_id, mock_aws_secret_access_key, mock_account_id
...
def test_aws_account_id_unexpected_error(aws_account_provider_mock: AwsAccountProvider):
    aws_account_provider_mock.client.get_caller_identity = MagicMock()
...
def test_configure_aws_cli_success(mock_run: MagicMock, aws_account_provider_mock: AwsAccountProvider):
    aws_account_provider_mock.configure_aws_cli()

    mock_run.assert_called_once_with(["aws", "configure"])


def test_configure_aws_cli_subprocess_error(mock_run: MagicMock, aws_account_provider_mock: AwsAccountProvider):
...
def test_configure_aws_cli_unexpected_error(mock_run: MagicMock, aws_account_provider_mock: AwsAccountProvider):
