...
from tests.tests_install.tests_resource_managers.mock_aws_cognito_resource_manager import participant_user_pool, researcher_user_pool, participant_user_pool_client, researcher_user_pool_client
