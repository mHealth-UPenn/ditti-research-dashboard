...
@pytest.mark.parametrize(
    ...
    [
        ("Missing ID", {"edit": {"name": "New Name"}}, "API ID not provided"),
        ("Non-existent ID", {"id": 9999, "edit": {"name": "New Name"}}, "API with ID 9999 does not exist"),
